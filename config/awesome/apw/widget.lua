...
local margin_right  = 4         -- right margin in pixels of progressbar
local margin_left   = 4         -- left margin in pixels of progressbar
local margin_top    = 10         -- top margin in pixels of progressbar
local margin_bottom = 8         -- bottom margin in pixels of progressbar
local step          = 0.05      -- stepsize for volume change (ranges from 0 to 1)
local color         = '#7aa2f7' --'#698f1e' -- foreground color of progessbar
local color_bg      = '#3660c3' --'#33450f' -- background color
