...
bg_default = "#1a1a1a"          # main shade darkest
bg_lighter = "#3c3c3c"
bg_selection = "#0077ff"
# "#545862"
fg_disabled = "#BCBCBC"
...
# "#d19a66"                     # orange
bg_hint = "#0077ff"             # blue
fg_matched_text = "#0077ff"     # blue
bg_passthrough_mode = "#56b6c2" # teal
bg_insert_mode = "#0077ff"      # blue
...
c.colors.tabs.odd.fg = fg_disabled
...
c.colors.tabs.pinned.selected.even.fg = fg_disabled

# Background color of pinned selected odd tabs.
c.colors.tabs.pinned.selected.odd.bg = bg_selection

# Foreground color of pinned selected odd tabs.
c.colors.tabs.pinned.selected.odd.fg = fg_disabled

# Foreground color of selected odd tabs.
c.colors.tabs.selected.odd.fg = fg_disabled

# Background color of selected odd tabs.
c.colors.tabs.selected.odd.bg = bg_selection

# Foreground color of selected even tabs.
c.colors.tabs.selected.even.fg = fg_disabled
